    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center">
        <Form name="signup" initialValues={{ remember: true }} onFinish={onFinish}>
          ...
          <Form.Item name="username" rules={[{ required: true, message: "Inserisci il tuo Username!" }]}>
          ...
          <Form.Item name="confirmPassword" dependencies={["password"]} rules={[{ required: true, message: "Conferma la Password!" }, validatePassword]}>
