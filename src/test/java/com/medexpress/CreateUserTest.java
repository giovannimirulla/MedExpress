...
public class CreateUserTest {
    ...
    void testCreateUser() throws Exception {
        ...
        User user = new User(
            ...
            "mario.rossi@example.com", "encryptedPassword123", 1, 
            new ObjectId(requestBody.get("doctor")), LocalDateTime.now(), LocalDateTime.now()
        );

        when(userService.createUser(anyString(), anyString(), anyString(), anyString(), anyString(), anyString(), anyInt(), any(ObjectId.class)))
        .thenReturn(user);
